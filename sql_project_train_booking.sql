...
CREATE TABLE `train_booking` (
  ...
  KEY `class10_idx` (`class_id`),
  CONSTRAINT `booking11` FOREIGN KEY (`booking_id`) REFERENCES `booking_table` (`booking_id`),
  CONSTRAINT `class10` FOREIGN KEY (`class_id`) REFERENCES `class` (`class_id`),
  CONSTRAINT `train` FOREIGN KEY (`train_id`) REFERENCES `trains` (`train_id`)
