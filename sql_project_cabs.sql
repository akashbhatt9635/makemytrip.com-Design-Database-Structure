...
CREATE TABLE `cabs` (
  ...
  `travel_company` varchar(45) NOT NULL,
  `city_id` varchar(20) NOT NULL,
  PRIMARY KEY (`cab_no`),
  KEY `servi4_idx` (`service_id`),
  KEY `city_idx` (`city_id`),
  CONSTRAINT `city` FOREIGN KEY (`city_id`) REFERENCES `cities` (`Cities_Id`),
  CONSTRAINT `servi4` FOREIGN KEY (`service_id`) REFERENCES `services` (`Services_Id`)
...
-- Dump completed on 2022-03-06 19:56:12
